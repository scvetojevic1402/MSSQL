...
AS
    ...
    Set @ParamDefinition = '@No_of_Clusters INT,@Column NVARCHAR(250),@TABLENAME NVARCHAR(250)'
    /* Execute the Transact-SQL String with all parameter value's Using sp_executesql Command */
    Execute sp_Executesql @SQL,@ParamDefinition,@No_of_Clusters,@Column,@TABLENAME
--EXAMPPLE USAGE:
